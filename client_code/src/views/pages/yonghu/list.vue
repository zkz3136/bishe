	...
	<div class="list-page" :style='{}'>
		...
		<el-form :inline="true" :model="searchQuery" class="list_search">
			...
			<div class="search_view">
				...
				<div class="search_box">
					<el-input class="search_inp" v-model="searchQuery.shoujihaoma" placeholder="手机号码"
						clearable>
					</el-input>
				</div>
			</div>
...
<script setup>
	...
	const getList = () => {
		...
		if(searchQuery.value.shoujihaoma&&searchQuery.value.shoujihaoma!=''){
			params.shoujihaoma = '%' + searchQuery.value.shoujihaoma + '%'
		}
		context?.$http({
