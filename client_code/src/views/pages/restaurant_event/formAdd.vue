			...
			<el-row>
				<el-col :span="12">
					<el-form-item label="活动名称" prop="event_name">
						<el-input class="list_inp" v-model="form.event_name" placeholder="活动名称"
							 type="text" 							:readonly="!isAdd||disabledForm.event_name?true:false" />
					</el-form-item>
				</el-col>

				<el-col :span="24">
					<el-form-item label="活动图片" prop="event_image">
						<uploads
				...
				<el-col :span="24">
					<el-form-item label="活动内容" prop="event_content">
						<editor class="list_editor" :value="form.event_content" placeholder="请输入活动内容" :readonly="!isAdd||disabledForm.event_content?true:false"
							@change="(e)=>editorChange(e,'event_content')"></editor>
					</el-form-item>
				</el-col>
			</el-row>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.event_content = res.data.data.event_content.replace(reg,'../../../canteen/file');
