			...
			<div class="info_view">
				<div class="title_view">
					<div class="detail_title">
						<span>{{detail.spot_number}}</span>
					</div>
				</div>
				<div class="info_item">
					<div class="info_label">区域</div>
					<div  class="info_text" >{{detail.area}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">车位位置</div>
					<div  class="info_text" >{{detail.spot_location}}</div>
				</div>
				<div class="info_item">
				...
				<div class="btn_view">
					...
					<el-button class="del_btn" v-if="centerType&&btnAuth('parking_spot','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
...
<script setup>
	...
	const getDetail = (id) => {
		context?.$http({
            ...
            bannerList.value = res.data.data.spot_image?res.data.data.spot_image.split(','):[]
            title.value = res.data.data.spot_number
