				...
				<el-col :span="12">
					<el-form-item label="车位编号" prop="spot_number">
						<el-input class="list_inp" v-model="form.spot_number" placeholder="车位编号"
							 type="text" 							:readonly="!isAdd||disabledForm.spot_number?true:false" />
					</el-form-item>
				</el-col>

				<el-col :span="24">
					<el-form-item label="车位图片" prop="spot_image">
						<uploads
				...
				<el-col :span="12">
					<el-form-item label="车位位置" prop="spot_location">
						<el-input class="list_inp" v-model="form.spot_location" placeholder="车位位置"
							 type="text" 							:readonly="!isAdd||disabledForm.spot_location?true:false" />
					</el-form-item>
				</el-col>
