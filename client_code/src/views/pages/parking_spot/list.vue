    ...
    <div class="search_view">
        ...
        <div class="search_box">
			...
			<div class="search_btn_view">
				...
				<el-button class="add_btn" type="success" v-if="btnAuth('parking_spot','新增')" @click="addClick">新增</el-button>
			</div>
		</el-form>
		<div class="page_list">
			<div class="data_box">
				<div class="data_view">
					<div class="data_item" v-for="(item,index) in list" :key="index" @click.stop="detailClick(item.id)" >
						<div class="data_img_box" v-if="item.spot_image && item.spot_image.substr(0,4)=='http'" @click.stop="preViewClick(item.spot_image)">
							<el-image class="data_img" :src="item.spot_image" fit="cover"></el-image>
						</div>
						<div class="data_img_box" v-else @click.stop="preViewClick($config.url+item.spot_image.split(',')[0])">
							<el-image class="data_img" :src="item.spot_image?$config.url + item.spot_image.split(',')[0]:''"
								fit="cover"></el-image>
						</div>
						<div class="data_content">
							<div class="data_title1">
								<span>车位编号：{{item.spot_number}}</span>
							</div>
...
<script setup>
	...
	const addClick = () => {
		router.push('/index/parking_spotAdd')
	}
	//判断是否从个人中心跳转
