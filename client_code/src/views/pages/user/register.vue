		...
		<div class="register_view">
			...
			<el-form :model="registerForm" class="register_form">
				...
				<div class="list_item">
					...
					<input class="list_inp" v-model="registerForm.password2" type="password" placeholder="请输入确认密码" />
				</div>
				<div class="list_item">
...
<script setup>
	...
	const handleRegister = () => {
		...
		if(registerForm.value.balance&&(!context?.$toolUtil.isNumber(registerForm.value.balance))){
