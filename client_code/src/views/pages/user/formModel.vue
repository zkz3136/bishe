		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					...
					<div  class="info_text" >{{detail.login_name}}</div>
				</div>
				<div class="info_item">
				...
				<div class="info_item">
					...
					<div  class="info_text" >{{detail.gender}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">手机号码</div>
					<div  class="info_text" >{{detail.mobile}}</div>
				</div>
				<div class="btn_view">
					<el-button class="edit_btn" v-if="centerType&&btnAuth('user','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('user','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
