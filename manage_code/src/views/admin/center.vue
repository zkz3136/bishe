				...
				<el-row>
					<el-col :span="24">
						<el-form-item label="用户名" prop="username">
							<el-input class="list_inp" v-model="user.username" readonly placeholder="用户名" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="24">
						<el-form-item label="图片" prop="avatar">
							<uploads
								...
								@change="usersavatarUploadSuccess">
							</uploads>
						</el-form-item>
					</el-col>
...
<script setup>
	...
	const tableName = ref('admin')
	const user = ref({})
	const init = () => {
	}
	const usersavatarUploadSuccess=(fileUrls)=> {
